...
class RepositoriesFragment : Fragment()
{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        repositoriesAdapter.submitList(
            listOf(
                Repository("okhhtp", "square", 2000, 100, "https://avatars.githubusercontent.com/u/82592?v=4", false),
                Repository("retrofit", "circle", 3000, 200, "https://avatars.githubusercontent.com/u/82592?v=4", true),
                Repository("kotlin", "rectangle", 4000, 300, "https://avatars.githubusercontent.com/u/82592?v=4", false),
            )
        )
    }
